 ...
 * {@link com.weisen.www.code.yjf.login.domain.SmsService}.
 */
@RestController
@RequestMapping("/api")
@Api(tags = "001-短信操作")
public class Rewrite_SmsServiceResource {
	 ...
	 *         body the new smsServiceDTO, or with status {@code 400 (Bad Request)}
	 *         if the smsService has already an ID.
	...
	public String validateCode(@RequestBody Rewrite_200_PayPasswordCodeDTO payPasswordCodeDTO) {
		...
		return rewrite_SmsServiceService.validateCode(payPasswordCodeDTO.getPhone(),
				payPasswordCodeDTO.getVertifyCode(), "修改支付密码");
	}
